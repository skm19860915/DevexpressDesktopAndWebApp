...
{
    public class VacationExpressConverter : ConverterBase, ITourOperatorDBConverter
    {
        ...
        public string GetLocation(string aLocation)
        {
            ...
            {
                BlitzerCore.Utilities.Logger.LogWarning("Vacation Express Bot found incorrectly formatted location.  Missing : [{aLocation}]");
                return aLocation;
            }
        }
