...
{
    public enum Environment { NONE, PROD, BETA, DEV }

    public class RepositoryContext : DbContext, IDbContext
    {
        private static RepositoryContext instance = null;

        public static Environment Environment {get; set; }

        private RepositoryContext(Environment aEnv)
        {
        ...
        public static RepositoryContext Instance
        {
            ...
            {
                if (instance == null)
                    instance = new RepositoryContext(Environment);
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(ConnectionString, b => b.MigrationsAssembly("Desktop"));
        }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Contact>().HasOne(a => a.OwnedBy).WithMany(c => c.Clients);
