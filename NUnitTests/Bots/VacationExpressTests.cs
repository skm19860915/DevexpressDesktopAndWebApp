...
namespace NUnitTests.Bots
{
    class VacationExpressTests
    {
        ...
        public void ParseErrorPage()
        {
            ...
            var lWADBot = new VacationExpressBot(mContext);
        ...
        {
            var lWebBot = new VacationExpressFileBot(mContext);
            ...
            Assert.AreEqual(26, lResorts.Hotels.Count());
            lWebBot.Close();
        }
