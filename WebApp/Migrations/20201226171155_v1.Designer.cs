...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlitzerCore.Models.AccommodationRoomType", b =>
                {
                    ...
                    b.Property<int>("AccommodiationID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AccommodationRoomTypeID");

                    b.HasIndex("AccommodiationID");

                    b.ToTable("AccommodationRoomTypes");
                });
            ...
            modelBuilder.Entity("BlitzerCore.Models.Address", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BlitzerCore.Models.AddressMap", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AddressMap");
                });

            modelBuilder.Entity("BlitzerCore.Models.AddressType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BlitzerCore.Models.AppUser", b =>
                {
                    ...
                    b.Property<int?>("FoodBasket")
                        .HasColumnType("int");

                    b.Property<int>("FoodBasketId")
                        .HasColumnType("int");

                    b.Property<int?>("Gender")
                        .HasColumnType("int");

                    b.Property<string>("GlobelEntryNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BlitzerCore.Models.Email", b =>
                {
                    ...
                    b.Property<string>("BlitzerUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BlitzerCore.Models.FoodBasket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BlitzerCore.Models.Passport", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BlitzerCore.Models.QuoteRequestTicket", b =>
                {
            ...
            modelBuilder.Entity("BlitzerCore.Models.Agent", b =>
                {
                    b.HasBaseType("BlitzerCore.Models.AppUser");
            ...
            modelBuilder.Entity("BlitzerCore.Models.Assistant", b =>
                {
                    b.HasBaseType("BlitzerCore.Models.AppUser");
            ...
            modelBuilder.Entity("BlitzerCore.Models.Lead", b =>
                {
                    b.HasBaseType("BlitzerCore.Models.AppUser");
            ...
            modelBuilder.Entity("BlitzerCore.Models.UI.UIResort", b =>
                {
                    b.HasBaseType("BlitzerCore.Models.UI.Page");
                    ...
                    b.HasDiscriminator().HasValue("UIResort");
                });

            modelBuilder.Entity("BlitzerCore.Models.Client", b =>
                {
                    b.HasBaseType("BlitzerCore.Models.Lead");

                    b.Property<int>("AddressMapID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlitzerCore.Models.AccommodationRoomType", b =>
                {
                    b.HasOne("BlitzerCore.Models.Hotel", "Accommodation")
                        .WithMany()
                        .HasForeignKey("AccommodiationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("BlitzerCore.Models.AddressMap", b =>
                {
                    b.HasOne("BlitzerCore.Models.Address", "Address")
                        .WithMany()
                        .HasForeignKey("AddressID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlitzerCore.Models.AddressType", "AddressType")
                        .WithMany()
                        .HasForeignKey("AddressTypeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlitzerCore.Models.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzerCore.Models.AppUser", b =>
                {
                    ...
                    b.HasOne("BlitzerCore.Models.FoodBasket", "CC")
                        .WithMany()
                        .HasForeignKey("FoodBasket");
                });
            ...
            modelBuilder.Entity("BlitzerCore.Models.Email", b =>
                {
                    b.HasOne("WebApp.DataServices.BlitzerUser", null)
                        .WithMany("Emails")
                        .HasForeignKey("BlitzerUserId");

                    b.HasOne("BlitzerCore.Models.Company", null)
                        .WithMany("Emails")
                        .HasForeignKey("CompanyId");
            ...
            modelBuilder.Entity("BlitzerCore.Models.Invoice", b =>
                {
                    b.HasOne("BlitzerCore.Models.Client", "Billee")
                        .WithMany()
                        .HasForeignKey("ContactID");
            ...
            modelBuilder.Entity("BlitzerCore.Models.MemberShip", b =>
                {
                    b.HasOne("BlitzerCore.Models.AppUser", null)
                        .WithMany("CarMemberShip")
                        .HasForeignKey("AppUserId");

                    b.HasOne("BlitzerCore.Models.AppUser", null)
                        .WithMany("FrequentFlyer")
                        .HasForeignKey("AppUserId1");

                    b.HasOne("BlitzerCore.Models.AppUser", null)
                        .WithMany("HotelMemberShip")
            ...
            modelBuilder.Entity("BlitzerCore.Models.Note", b =>
                {
                    b.HasOne("BlitzerCore.Models.AppUser", "Writer")
                        .WithMany("Notes")
            ...
            modelBuilder.Entity("BlitzerCore.Models.Opportunity", b =>
                {
                    ...
                    b.HasOne("BlitzerCore.Models.Stage", "Stage")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzerCore.Models.Payment", b =>
                {
                    ...
                    b.HasOne("BlitzerCore.Models.Client", "Payee")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzerCore.Models.Post", b =>
                {
                    b.HasOne("BlitzerCore.Models.AppUser", "Approver")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzerCore.Models.QuoteRequestResort", b =>
                {
                    ...
                    b.HasOne("BlitzerCore.Models.AccommodationRoomType", "AccommodationRoomType")
                        .WithMany()
                        .HasForeignKey("AccommodationRoomTypeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlitzerCore.Models.AppUser", "BookedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzerCore.Models.QuoteToResultsMapper", b =>
                {
                    ...
                    b.HasOne("BlitzerCore.Models.QuoteRequestTicket", "QuoteRequestTicket")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzerCore.Models.Ranking", b =>
                {
                    ...
                    b.HasOne("BlitzerCore.Models.UI.UIResort", "ResortPage")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzerCore.Models.RelationshipMap", b =>
                {
                    b.HasOne("BlitzerCore.Models.AppUser", "Primary")
                        .WithMany()
                    ...
                    b.HasOne("BlitzerCore.Models.AppUser", "Target")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzerCore.Models.Transportation", b =>
                {
                    ...
                    b.HasOne("BlitzerCore.Models.QuoteRequest", "Quote")
                        .WithMany()
                        .HasForeignKey("QuoteID");
            ...
            modelBuilder.Entity("BlitzerCore.Models.UI.Page", b =>
                {
                    b.HasOne("BlitzerCore.Models.AppUser", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzerCore.Models.UserMap", b =>
                {
                    ...
                    b.HasOne("BlitzerCore.Models.Lead", "User")
                        .WithMany()
                        .HasForeignKey("UserID");
                });
            ...
            modelBuilder.Entity("BlitzerCore.Models.Merchant", b =>
                {
                    b.HasOne("BlitzerCore.Models.AppUser", "SalesPerson")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzerCore.Models.Resort", b =>
                {
                    ...
                    b.HasOne("BlitzerCore.Models.UI.UIResort", "Page")
                        .WithMany()
                        .HasForeignKey("PageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BlitzerCore.Models.UI.Comparable", b =>
                {
                    ...
                    b.HasOne("BlitzerCore.Models.UI.UIResort", "CompPage")
                        .WithMany("Comparables")
            ...
            modelBuilder.Entity("BlitzerCore.Models.Client", b =>
                {
                    b.HasOne("BlitzerCore.Models.AddressMap", "AddressMap")
                        .WithMany()
                        .HasForeignKey("AddressMapID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlitzerCore.Models.Passport", "Passport")
                        .WithMany()
