...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlitzerCore.Models.Task", b =>
                {
                    ...
                    b.Property<DateTime?>("ReOccuringEnd")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("ReOccuringStart")
                        .HasColumnType("datetime2");

                    b.Property<bool>("Saturday")
                        .HasColumnType("bit");

                    b.Property<long>("SaveMask")
                    ...
                    b.Property<bool?>("TempDatesCalculated")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("usingProjectsPriority")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BlitzerCore.Models.QuoteRequestResort", b =>
                {
                    ...
                    b.HasOne("BlitzerCore.Models.Resort", "Resort")
                        .WithMany()
                        .HasForeignKey("ResortId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlitzerCore.Models.AccommodationRoomType", "ResortRoomType")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzerCore.Models.QuoteRequestTicket", b =>
                {
                    ...
                    b.HasOne("BlitzerCore.Models.QuoteGroup", null)
                        .WithMany("Flights")
                        .HasForeignKey("QuoteGroupId");
            ...
            modelBuilder.Entity("BlitzerCore.Models.Task", b =>
                {
                    b.HasOne("BlitzerCore.Models.Contact", "Creator")
                        .WithMany()
                    ...
                    b.HasOne("BlitzerCore.Models.Opportunity", "Project")
                        .WithMany()
                        .HasForeignKey("OpportunityID");

                    b.HasOne("BlitzerCore.Models.Team", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzerCore.Models.Merchant", b =>
                {
                    b.HasOne("BlitzerCore.Models.Contact", "SalesPerson")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzerCore.Models.Assistant", b =>
                {
                    b.HasOne("BlitzerCore.Models.Assistant", null)
                        .WithMany("Assistants")
                        .HasForeignKey("AssistantId");

                    b.HasOne("BlitzerCore.Models.Client", null)
                        .WithMany("Assistants")
