...
namespace WebApp.SrvUtilities
{
    public class EmailHelper : IEmailHelper
    {
        ...
        public const string ADMIN_EMAIL = "eric@eze2travel.com";
        public const string SILKE_EMAIL = "Silke@eze2travel.com";
        ...
        {
            ///string lDB = Configuration["ConnectionString:DefaultConnection"];
            ...
            if (isDebugMode())
            {
                lMail.To.Add(ADMIN_EMAIL);
                lMail.To.Add(SILKE_EMAIL);
